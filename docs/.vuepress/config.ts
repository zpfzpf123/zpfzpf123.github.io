...
export default defineUserConfig({
  ...
  lang: 'zh-CN',
  title: '周鹏飞的个人博客网',
  description: '把我学习的知识笔记以及文档进行展示的网站',
  ...
  theme: plumeTheme({
    sidebarDepth: 5, // 设置为 5 以显示到五级标题
    displayAllHeaders: true, // 显示所有页面的标题
    profile: {
      name: '周鹏飞',
      description: '任他明月下西楼',
      avatar: '../img/周鹏飞.jpg',
    ...
    // 社交链接
    social: [
      { icon: 'github', link: 'https://github.com/zpfzpf123' },
      // ... more
    ],
    ...
    plugins: {
      ...
      shiki: {
        ...
        languages: ['typescript', 'javascript','vue','html','less','scss','css'],
